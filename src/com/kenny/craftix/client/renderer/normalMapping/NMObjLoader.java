...
public class NMObjLoader 
{
	...
	/**
	* Just a load obj model with use a normal mapping effect.
	*/
	
	
	public static Model loadOBJ(String file, Loader loader) 
	{
		...
		return loader.loadToVao(verticesArray, texturesArray, normalsArray, tangentsArray, 
				indicesArray);
	}
