...
import com.kenny.craftix.client.text.TextMeshCreator;
...
public class MetaFile 
{
    ...
    /**AspectRatio is a dived width on height display.*/
    ...
    public void close() 
    {
        ...
        {
        	LOGGER.error("Can't close the reader with unknown reason.");
            e.printStackTrace();
        }
    }
     ...
     */
    public void loadCharacterData(int imageWidth) 
    {
        processNextLine();
        processNextLine();
