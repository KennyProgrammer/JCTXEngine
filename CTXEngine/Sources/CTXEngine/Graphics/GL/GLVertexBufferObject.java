...
public class GLVertexBufferObject extends VertexBufferObject
{
	...
	public void create()
	{
		...
		{
			CTX_ENGINE_ERROR("Vertex Buffer is already created from this reference." +
	...
	public void destroy()
	{
		...
		{
			CTX_ENGINE_ERROR("Vertex Buffer is not created from this reference." +
				"Use create() to create buffer."); System.exit(-1);
		}
	}
	...
	public void putData()
	{
		...
		GLHelper.hglBufferData(this.getType(), this.size, this.data, this.usage);
	}
	...
	public void unBind()
	{
		if (this.isSelected())
		{
			glBindBuffer(this.getType(), this.getId());
			this.selected = false;
		}
	}
